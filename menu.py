...
print("Welcome to the KoKo food truck.") 
print("We have a variety of items on our menu.")                                                                                                           
# 3. Create a continuous loop for the customer to order items  
# Set the place_order variable to True to start the loop                                                
...
while place_order:                                                                                                     
        ...
        if int(menu_category) in menu_items.keys():
            ...
            if menu_item_number.isdigit():                                                                            
                ...
                # Tell the customer they didn't select a menu option
                    ...
                    print("sorry that number isn't an option was not a menu option.")
        # Tell the customer they didn't select a number
            else:
                print(f"{menu_item_number} was not a menu selection.")
        else:
            # Tell the customer they didn't select a menu option
    ...
    while True:
        ...
        # 5. Check the customer's input to see if they want to keep ordering                                            
...
for item in order:               
    ...
    # Store the quantity as a variable      
    ...
    print(f"{item_name}{item_spaces}| ${price_spaces} | {quantity}")                                                           
